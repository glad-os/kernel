...
#define GPIO_H
	...
	#define		ARM_GPIO_PIN_ENABLE_PULL_DOWN					0b01
	#define		ARM_GPIO_PIN_ENABLE_PULL_UP						0b10

	#define		GPIO_SELECT_ALTERNATIVE_FUNCTION_0				0b000
	#define		GPIO_SELECT_ALTERNATIVE_FUNCTION_1				0b001
	#define		GPIO_SELECT_ALTERNATIVE_FUNCTION_2				0b010
	#define		GPIO_SELECT_ALTERNATIVE_FUNCTION_3				0b011
	#define		GPIO_SELECT_ALTERNATIVE_FUNCTION_4				0b100
	#define		GPIO_SELECT_ALTERNATIVE_FUNCTION_5				0b101

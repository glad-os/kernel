...
#define INTERRUPT_H
	...
	// Raspberry Pi 4 shuffles round the pending registers
	...
	#define		ARM_INTERRUPT_PENDING_1_REGISTER			( ARM_INTERRUPT_REGISTERS + 0x00 )
	#define		ARM_INTERRUPT_PENDING_2_REGISTER			( ARM_INTERRUPT_REGISTERS + 0x04 )
	#define		ARM_INTERRUPT_BASIC_PENDING_REGISTER			( ARM_INTERRUPT_REGISTERS + 0x08 )
	...
	// Raspberry Pi 4 moves these along in memory by 4 bytes as well
	...
	#define		ARM_INTERRUPT_DISABLE_IRQS_1_REGISTER			( ARM_INTERRUPT_REGISTERS + 0x20 )
	#define		ARM_INTERRUPT_DISABLE_IRQS_2_REGISTER			( ARM_INTERRUPT_REGISTERS + 0x24 )
	#define		ARM_INTERRUPT_DISABLE_BASIC_IRQS_REGISTER		( ARM_INTERRUPT_REGISTERS + 0x28 )

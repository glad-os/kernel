...
// Pi4 - these got swapped round
#define ARM_IC_IRQ_PENDING_1	  (ARM_IC_BASE + 0x200)
#define ARM_IC_IRQ_PENDING_2	  (ARM_IC_BASE + 0x204)
#define ARM_IC_IRQ_BASIC_PENDING  (ARM_IC_BASE + 0x208)
